...
internal val LightCalioColors = CalioColors(
    ...
    workingHoursBand = Color(0x081B6EF3),
    workingHoursEdge = Color(0x3D1B6EF3),
...
internal val DarkCalioColors = CalioColors(
    ...
    nonWorkingHours = Color(0x2B000000),
    workingHoursBand = Color(0x0F9FC0FF),
    workingHoursEdge = Color(0x3D9FC0FF),
